 ...
 * generated in the it.storelink.openmaintmango.xmlconfig package. 
...
public class ObjectFactory {
    ...
    private final static QName _OpemaintTypeField_QNAME = new QName("http://www.w3.org/2001/XMLSchema", "field");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.storelink.openmaintmango.xmlconfig
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.w3.org/2001/XMLSchema", name = "field", scope = OpemaintType.class)
    public JAXBElement<FieldType> createOpemaintTypeField(FieldType value) {
        return new JAXBElement<FieldType>(_OpemaintTypeField_QNAME, FieldType.class, OpemaintType.class, value);
    }
